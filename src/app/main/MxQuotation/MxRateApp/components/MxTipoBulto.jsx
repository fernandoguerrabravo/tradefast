...
const MxTipoBulto = ({ hidden, sethidden, setfinales, finales }) => {
	...
	return (
		<div className={classes.root}>
			<Grid container spacing={3}>
				...
				<Grid item xs={12}>
					<RadioGroup aria-label="gender" name="gender1" value={finales.tipoflete} onChange={handleChange}>
						<Grid container spacing={3}>
							<Grid item xs={6}>
