	...
	const handleChangegarantizado = e => {
		switch (e.target.value) {
			case '2300':
				...
				setfinales({
					...finales,
					totalflete: 2369.84 + 150 + 145,
					bodegamx: e.target.value,
					qtypallets: 13
				});
							...
							<>
								<Grid item xs={12}>
									<Paper className={classes.paper}>
										<Typography>
											<strong>Select Fedex Facilities (MX)</strong>
										</Typography>
										<br />
								...
								<Grid item xs={12}>
									<Paper className={classes.paper}>
										<Typography>
											El servicio <strong style={{ color: '#FF9900' }}>"Garantizado" </strong>
											tiene un periodo máximo de 48 horas de salida desde el momento de la
											confirmacion de su booking.
										</Typography>
									</Paper>
								</Grid>
							</>
						...
						<Grid item xs={12}>
							<Paper className={classes.paper}>
								<h6>
									...
									indicadas; Despacho Audanero Export-Import; transporte hasta Laredo; y recepcion &
