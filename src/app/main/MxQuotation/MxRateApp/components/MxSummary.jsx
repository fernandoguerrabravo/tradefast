...
const MxSummary = ({ mexico, setmexico }) => {
									...
									<TableBody>
										<TableRow>
											...
											<TableCell component="th" scope="row" style={{ color: '#FF9900' }}>
												<strong>{formatter.format(mexico.totalflete)}</strong>
											</TableCell>
										</TableRow>
										<TableRow>
											<TableCell component="th" scope="row">
											...
											<TableCell component="th" scope="row" style={{ color: '#FF9900' }}>
												<strong>{formatter.format(mexico.totalhandlingout)}</strong>
											</TableCell>
										</TableRow>
										<TableRow>
											<TableCell component="th" scope="row">
											...
											<TableCell component="th" scope="row">
												<Typography variant="h6" style={{ color: '#FF9900' }}>
													<strong>{formatter.format(mexico.totalflete + mexico.totalhandlingout)}</strong>
												</Typography>
											</TableCell>
										</TableRow>
										{ /* <TableRow>
